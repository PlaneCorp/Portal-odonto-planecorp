...
$listener.Start()
Write-Host "Serving $root on http://localhost:$port/Comparativo-Odonto-PlaneCorp/"
...
while ($listener.IsListening) {
  try {
    ...
    if ([string]::IsNullOrWhiteSpace($rel)) { $rel = "Comparativo-Odonto-PlaneCorp/index.html" }
